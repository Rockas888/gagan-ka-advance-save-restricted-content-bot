        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[MAHABALI](https://t.me/dev_gagan)__**\n ",
                    edit,
                    time.time()
                )
            )
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                try:
                    ...
                    logging.info(e)
                    thumb_path = None
                caption = f"{msg.caption}\n\n__Unrestricted by **[MAHABALI](https://t.me/dev_gagan)**__" if msg.caption else "__Unrestricted by **[MAHABALI](https://t.me/dev_gagan)**__"
                await client.send_video(
                    ...
                    progress_args=(
                        client,
                        '**UPLOADING: __[MAHABALI](https://t.me/dev_gagan)__**\n ',
                        upm,
                        time.time()
                    )
                )
                ...
                await client.send_document(
                    ...
                    progress_args=(
                        client,
                        '**UPLOADING:**\n**Bot made by [MAHABALI](https://t.me/dev_gagan)**',
                        upm,
                        time.time()
                    )
                )
